...
public abstract class BlockRedSandstoneSlab extends BlockSlab {
  public static final PropertyEnum<RedSandstoneType> VARIANT =
      PropertyEnum.create("variant", RedSandstoneType.class,
                          (type) -> type == RedSandstoneType.SMOOTH);

  public BlockRedSandstoneSlab(String id, String translationKey) {
    super(Material.ROCK);
    ...
    this.setDefaultState(state.withProperty(VARIANT, RedSandstoneType.SMOOTH));
  ...
  public Item getItemDropped(IBlockState state, Random rand, int fortune) {
    return Item.getItemFromBlock(ReFlectBlocks.RED_SANDSTONE_SLAB);
  }

  public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
    return new ItemStack(ReFlectBlocks.RED_SANDSTONE_SLAB, 1,
                         (state.getValue(VARIANT)).getMetadata());
  }

  public String getTranslationKey(int meta) {
    return super.getTranslationKey() + "." +
        RedSandstoneType.byMetadata(meta).getTranslationKey();
  }

  public IProperty<?> getVariantProperty() { return VARIANT; }

  public Comparable<?> getTypeForItem(ItemStack stack) {
    return RedSandstoneType.byMetadata(stack.getMetadata() & 7);
  }

  public void getSubBlocks(CreativeTabs itemIn, NonNullList<ItemStack> items) {
    items.add(new ItemStack(this, 1, RedSandstoneType.SMOOTH.getMetadata()));
  }

  public IBlockState getStateFromMeta(int meta) {
    IBlockState state = this.getDefaultState().withProperty(
        VARIANT, RedSandstoneType.byMetadata(meta & 7));
  ...
  public static class Double extends BlockRedSandstoneSlab {
  ...
  public static class Half extends BlockRedSandstoneSlab {
