...
public class BlockPrismarineWall extends BlockWall {
  public static final PropertyEnum<PrismarineType> VARIANT =
      PropertyEnum.create("variant", PrismarineType.class,
                          (type) -> type == PrismarineType.ROUGH);

  public BlockPrismarineWall(String id, String translationKey) {
  ...
  public void getSubBlocks(CreativeTabs itemIn, NonNullList<ItemStack> items) {
    items.add(new ItemStack(this, 1, PrismarineType.ROUGH.getMetadata()));
  }
  ...
  public IBlockState getStateFromMeta(int meta) {
    return this.getDefaultState().withProperty(VARIANT,
                                               PrismarineType.byMetadata(meta));
  }
