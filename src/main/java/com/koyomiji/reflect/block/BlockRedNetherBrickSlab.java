...
public abstract class BlockRedNetherBrickSlab extends BlockSlab {
  public static final PropertyEnum<RedNetherBrickType> VARIANT =
      PropertyEnum.create("variant", RedNetherBrickType.class);

  public BlockRedNetherBrickSlab(String id, String translationKey) {
    super(Material.ROCK);
    ...
    this.setDefaultState(
        state.withProperty(VARIANT, RedNetherBrickType.DEFAULT));
  ...
  public Item getItemDropped(IBlockState state, Random rand, int fortune) {
    return Item.getItemFromBlock(ReFlectBlocks.RED_NETHER_BRICK_SLAB);
  }

  public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
    return new ItemStack(ReFlectBlocks.RED_NETHER_BRICK_SLAB, 1,
                         (state.getValue(VARIANT)).getMetadata());
  }

  public String getTranslationKey(int meta) {
    return super.getTranslationKey() + "." +
        RedNetherBrickType.byMetadata(meta).getTranslationKey();
  }

  public IProperty<?> getVariantProperty() { return VARIANT; }

  public Comparable<?> getTypeForItem(ItemStack stack) {
    return RedNetherBrickType.byMetadata(stack.getMetadata() & 7);
  }
  ...
  public IBlockState getStateFromMeta(int meta) {
    IBlockState state = this.getDefaultState().withProperty(
        VARIANT, RedNetherBrickType.byMetadata(meta & 7));
  ...
  public static class Double extends BlockRedNetherBrickSlab {
  ...
  public static class Half extends BlockRedNetherBrickSlab {
