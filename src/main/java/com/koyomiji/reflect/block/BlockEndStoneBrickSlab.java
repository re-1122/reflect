...
public abstract class BlockEndStoneBrickSlab extends BlockSlab {
  public static final PropertyEnum<EndStoneBrickType> VARIANT =
      PropertyEnum.create("variant", EndStoneBrickType.class);

  public BlockEndStoneBrickSlab(String id, String translationKey) {
    super(Material.ROCK);
    ...
    this.setDefaultState(
        state.withProperty(VARIANT, EndStoneBrickType.DEFAULT));
  ...
  public Item getItemDropped(IBlockState state, Random rand, int fortune) {
    return Item.getItemFromBlock(ReFlectBlocks.END_BRICK_SLAB);
  }

  public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
    return new ItemStack(ReFlectBlocks.END_BRICK_SLAB, 1,
                         (state.getValue(VARIANT)).getMetadata());
  }

  public String getTranslationKey(int meta) {
    return super.getTranslationKey() + "." +
        EndStoneBrickType.byMetadata(meta).getTranslationKey();
  }

  public IProperty<?> getVariantProperty() { return VARIANT; }

  public Comparable<?> getTypeForItem(ItemStack stack) {
    return EndStoneBrickType.byMetadata(stack.getMetadata() & 7);
  }
  ...
  public IBlockState getStateFromMeta(int meta) {
    IBlockState state = this.getDefaultState().withProperty(
        VARIANT, EndStoneBrickType.byMetadata(meta & 7));
  ...
  public static class Double extends BlockEndStoneBrickSlab {
  ...
  public static class Half extends BlockEndStoneBrickSlab {
