...
public abstract class BlockSmoothStoneSlab extends BlockSlab {
  public static final PropertyEnum<SmoothStoneType> VARIANT =
      PropertyEnum.create("variant", SmoothStoneType.class);

  public BlockSmoothStoneSlab(String id, String translationKey) {
    super(Material.ROCK);
    ...
    this.setDefaultState(state.withProperty(VARIANT, SmoothStoneType.STONE));
  ...
  public Item getItemDropped(IBlockState state, Random rand, int fortune) {
    return Item.getItemFromBlock(ReFlectBlocks.SMOOTH_STONE_SLAB);
  }

  public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
    return new ItemStack(ReFlectBlocks.SMOOTH_STONE_SLAB, 1,
                         (state.getValue(VARIANT)).getMetadata());
  }

  public String getTranslationKey(int meta) {
    return super.getTranslationKey() + "." +
        SmoothStoneType.byMetadata(meta).getTranslationKey();
  }

  public IProperty<?> getVariantProperty() { return VARIANT; }

  public Comparable<?> getTypeForItem(ItemStack stack) {
    return SmoothStoneType.byMetadata(stack.getMetadata() & 7);
  }

  public void getSubBlocks(CreativeTabs itemIn, NonNullList<ItemStack> items) {
    items.add(new ItemStack(this, 1, SmoothStoneType.SANDSTONE.getMetadata()));
    items.add(new ItemStack(this, 1, SmoothStoneType.QUARTZ.getMetadata()));
    items.add(
        new ItemStack(this, 1, SmoothStoneType.RED_SANDSTONE.getMetadata()));
  }

  public IBlockState getStateFromMeta(int meta) {
    IBlockState state = this.getDefaultState().withProperty(
        VARIANT, SmoothStoneType.byMetadata(meta & 7));
  ...
  public static class Double extends BlockSmoothStoneSlab {
  ...
  public static class Half extends BlockSmoothStoneSlab {
