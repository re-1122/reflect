...
public class BlockStrippedLog2 extends BlockNewLog {
  public BlockStrippedLog2(String id, String translationKey) {
    setRegistryName(ReFlect.MODID, id);
    setTranslationKey(I18nUtil.join(ReFlect.MODID, translationKey));
  }

  public BlockStrippedLog2(String id) { this(id, id); }
