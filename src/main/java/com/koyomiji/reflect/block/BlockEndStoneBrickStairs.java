...
public class BlockEndStoneBrickStairs extends BlockStairs {
  public BlockEndStoneBrickStairs(IBlockState blockState, String id,
  ...
  public static class Default extends BlockCobblestoneStairs {
    public Default(String id, String translationKey) {
      super(Blocks.END_BRICKS.getDefaultState(), id, translationKey);
    }
