...
public abstract class BlockSandstoneSlab extends BlockSlab {
  public static final PropertyEnum<SandstoneType> VARIANT = PropertyEnum.create(
      "variant", SandstoneType.class, (type) -> type == SandstoneType.SMOOTH);

  public BlockSandstoneSlab(String id, String translationKey) {
    super(Material.ROCK);
    ...
    this.setDefaultState(state.withProperty(VARIANT, SandstoneType.SMOOTH));
  ...
  public Item getItemDropped(IBlockState state, Random rand, int fortune) {
    return Item.getItemFromBlock(ReFlectBlocks.SANDSTONE_SLAB);
  }

  public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
    return new ItemStack(ReFlectBlocks.SANDSTONE_SLAB, 1,
                         (state.getValue(VARIANT)).getMetadata());
  }

  public String getTranslationKey(int meta) {
    return super.getTranslationKey() + "." +
        SandstoneType.byMetadata(meta).getTranslationKey();
  }

  public IProperty<?> getVariantProperty() { return VARIANT; }

  public Comparable<?> getTypeForItem(ItemStack stack) {
    return SandstoneType.byMetadata(stack.getMetadata() & 7);
  }

  public void getSubBlocks(CreativeTabs itemIn, NonNullList<ItemStack> items) {
    items.add(new ItemStack(this, 1, SandstoneType.SMOOTH.getMetadata()));
  }

  public IBlockState getStateFromMeta(int meta) {
    IBlockState state = this.getDefaultState().withProperty(
        VARIANT, SandstoneType.byMetadata(meta & 7));
  ...
  public static class Double extends BlockSandstoneSlab {
  ...
  public static class Half extends BlockSandstoneSlab {
