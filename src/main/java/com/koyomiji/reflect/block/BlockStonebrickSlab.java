...
public abstract class BlockStonebrickSlab extends BlockSlab {
  public static final PropertyEnum<StonebrickType> VARIANT =
      PropertyEnum.create("variant", StonebrickType.class,
                          (type) -> type == StonebrickType.MOSSY);

  public BlockStonebrickSlab(String id, String translationKey) {
    super(Material.ROCK);
    ...
    this.setDefaultState(state.withProperty(VARIANT, StonebrickType.MOSSY));
  ...
  public Item getItemDropped(IBlockState state, Random rand, int fortune) {
    return Item.getItemFromBlock(ReFlectBlocks.STONE_BRICK_SLAB);
  }

  public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
    return new ItemStack(ReFlectBlocks.STONE_BRICK_SLAB, 1,
                         (state.getValue(VARIANT)).getMetadata());
  }

  public String getTranslationKey(int meta) {
    return super.getTranslationKey() + "." +
        StonebrickType.byMetadata(meta).getTranslationKey();
  }

  public IProperty<?> getVariantProperty() { return VARIANT; }

  public Comparable<?> getTypeForItem(ItemStack stack) {
    return StonebrickType.byMetadata(stack.getMetadata() & 7);
  }
  ...
  public IBlockState getStateFromMeta(int meta) {
    IBlockState state = this.getDefaultState().withProperty(
        VARIANT, StonebrickType.byMetadata(meta & 7));
  ...
  public static class Double extends BlockStonebrickSlab {
  ...
  public static class Half extends BlockStonebrickSlab {
